...
function Home() {
  ...
  <section>
    ...
    <div className="row mb-5 align-items-stretch">
      ...
      <li className="fs-3 m-5">
        <i className="bi bi-1-circle-fill m-2"></i>
        Choisir la catégorie d’artisanat dans le menu.
      </li>

      <li className="fs-3 m-5">
        <i className="bi bi-2-circle-fill m-2"></i>
        Choisir un artisan.
      </li>

      <li className="fs-3 m-5">
        <i className="bi bi-3-circle-fill m-2"></i>
        Le contacter via le formulaire de contact.
      </li>

      <li className="fs-3 m-5">
        <i className="bi bi-4-circle-fill m-2"></i>
