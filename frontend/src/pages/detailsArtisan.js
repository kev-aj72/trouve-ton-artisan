...
<p className="mb-2">
  <span className="artisan-detail-label">Localisation :</span>{" "}
  {artisan.Ville}
</p>
...
{artisan.Site_web && (
  <p className="mb-2">
    ...
    >
      ...
      <section>
  <h2 className="text-start fw-bold mb-4">
    Contactez l’artisan :
  </h2>
  ...
  <div className="row align-items-center mb-3">
    <label htmlFor="nom" className="col-12 col-md-2 form-label form-artisan-label mb-0">
      Nom:
    </label>
    ...
    <div className="col-12 col-md-10">
      <input
        ...
        id="nom"
        name="nom"
        className="form-control form-artisan"
        value={formData.nom}
  ...
  <div className="row align-items-center mb-3">
    <label htmlFor="email" className="col-12 col-md-2 form-label form-artisan-label mb-0">
      Email:
    </label>
  ...
  <div className="row align-items-center mb-3">
    <label htmlFor="objet" className="col-12 col-md-2 form-label form-artisan-label mb-0">
      Objet:
    </label>
  ...
  <div className="row mb-4">
    <label htmlFor="message" className="col-12 col-md-2 form-label form-artisan-label">
      Message:
    </label>
